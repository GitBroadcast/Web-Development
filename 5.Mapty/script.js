...
class App {
  ...
  #getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert('Location services not turned on.');
        }
      );
    }
  }
  ...
  #newWorkout(e) {
    //Short Hand function
    const validateData = (...input) => input.every(inp => Number.isFinite(inp));
  ...
  #moveToPopUp(e) {
    ...
    //When converted to string the prototype chain previously have will be gone
    // workout.click();
  }
  #setLocalStorage() {
    // Don't use local storage to store large amount of application cause it will slow down the application
    //Local Storage is bad practice
